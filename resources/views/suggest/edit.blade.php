                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="page-header">
                                ...
                                {!! Form::open([
                                    'route' => 'admin.suggests.storeProduct',
                                    'method' => 'POST',
                                    'files' => true,
                                ]) !!}
                                    <div class="form-group">
                                        {!! Form::label('suggest_id', trans('settings.suggest_id'), [
                                            'class' => 'col-sm-3 control-label'
                                        ]) !!}
                                        {!! Form::text('suggest_id', $suggestProduct->id, [
                                            'class' => 'form-control',
                                            'id' => 'suggest_id',
                                        ]) !!}
                                    </div>
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('name', $suggestProduct->name, [
                                            'class' => 'form-control',
                                            'id' => 'name',
                                        ]) !!}
                                    </div>
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('description', $suggestProduct->description, [
                                            'class' => 'form-control',
                                            'id' => 'description',
                                        ]) !!}
                                    </div>
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('price', $suggestProduct->price, [
                                            'class' => 'form-control',
                                            'id' => 'price',
                                        ]) !!}
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('category_id', $listCategories, $suggestProduct->category_id, [
                                            'class' => 'form-control']) !!}
                                    </div>
                                    <div class="form-group">
